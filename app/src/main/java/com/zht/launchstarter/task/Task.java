...
import com.zht.launchstarter.utils.DisPatcherExecutor;
...
public abstract class Task implements ITask{
    ...
    protected Context mContex = TaskDispatcher.getContext();
    protected boolean mIsMainProcess = TaskDispatcher.isMainProcess();
    private volatile  boolean mIsWating;//是否正在等待
    ...
    /**
     *T ask 执行在那个线程池，默认在IO的线程池
     * CPU 密集型的一定要切换到cpu的线程池
     */
    @Override
    ...
    public boolean isIsWating() {
        return mIsWating;
    }

    public void setWating(boolean mIsWating) {
        this.mIsWating = mIsWating;
    }
    ...
    public void setSend(boolean mIsSend) {
